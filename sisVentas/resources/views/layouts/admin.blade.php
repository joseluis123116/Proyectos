...
<html>
  <head>
    ...
    <!-- si algunos estilo no carga  ir a laravel collective para los estilos
     ademas modificamos el link href="css/bootstrap.min.css"
    por href="{{asset('css/bootstrap.min.css')}}"-->
    
    <link rel="stylesheet" href="{{asset('css/bootstrap.min.css')}}">

 <!-- carpeta bajada de estilo para el  select -->
...
-->
                ...
                <div class="box-body">
                  	<div class="row">
	                  	<div class="col-md-12">
                              ...
                              <!--creamos el yield para hacer  referencia a la plantilla para agregar contrenido  -->
                              @yield('contenido')
		                          <!--Fin Contenido-->
                           </div>
                        </div>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017 <a href="www.google.com.pe">Google</a>.</strong> All rights reserved.
      </footer>
