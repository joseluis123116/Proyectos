       ...
       <div class="row">
                  ...
                  <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                         <div class="form-group">
                              ...
                              <option value="seleccionar_C">..:: Seleccionar Cliente ::.. </option>
                  ...
                  <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                         ...
                         <label>Tipo de Comprobante</label>
                              <select name="tipo_comprobante" class="form-control">
                                     <option value="Seleccionar_tp">..:: Selec. Tip. Comprobante. ::.. </option>
                      ...
                      <div class="form-group">
                       <label>Articulo</label>
                        ...
                        <select name="pidarticulo" class="form-control selectpicker" id="pidarticulo" data-live-search="true">
                         <option value="Seleccionar_A">..:: Selec.Articulo. ::..</option>

                          @foreach($articulos as $articulo)
                          <!--crearemos un split (_)/direcncia de valor con otro/ ,varia ya que enviaremos el articulo ,id,stock,precio de venta por javascript -->
